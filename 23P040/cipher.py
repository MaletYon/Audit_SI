...
============================================================
  ...
  Auteur : BOWORI LOULE OCEANNE [23P040]
============================================================
"""
...
class App(tk.Tk):
    ...
    # --- Palette de couleurs ---
    COULEUR_FOND    = "#0d1f0f"   # Vert forêt très sombre (fond principal)
    COULEUR_CADRE   = "#132b16"   # Vert foncé (cadres)
    COULEUR_ACCENT  = "#f0c040"   # Or vif (titres, accents)
    COULEUR_TEXTE   = "#e8f5e9"   # Blanc verdâtre doux
    COULEUR_BOUTON  = "#1b5e20"   # Vert profond (boutons principaux)
    COULEUR_ENTREE  = "#071209"   # Vert très sombre (fond des champs)
    COULEUR_VERT    = "#76ff03"   # Vert fluo vif pour afficher les résultats
...
class PageMenu(tk.Frame):
    ...
    def __init__(self, parent, controleur):
        ...
        tk.Button(
            ...
            font=controleur.POLICE_BOUTON,
            bg="#b71c1c", fg=controleur.COULEUR_TEXTE,
...
class PageCesar(tk.Frame):
    ...
    def __init__(self, parent, controleur):
        ...
        tk.Button(
            ...
            font=controleur.POLICE_BOUTON,
            bg="#2e7d32", fg=controleur.COULEUR_TEXTE,
        ...
        tk.Button(
            ...
            font=controleur.POLICE_BOUTON,
            bg="#4e6b30", fg=controleur.COULEUR_TEXTE,
