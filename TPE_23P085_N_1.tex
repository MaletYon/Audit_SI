...
\vspace*{1.5cm}
 ...
 \begin{center}
     \includegraphics[height=2.5cm]{figures/logo_uy1.jpeg}
 \end{center}
...
\input{chapitres/05_theorie_information_shannon}

% Chapitre 6B — Outil d'aide à d'audit SI
\input{chapitres/06_outil_aide_audit}

% Chapitre 6C —décomposition
\input{chapitres/06b_decomposition_types_audit}
...
\input{chapitres/07_sujets_connexes}

% Chapitre 8 — Évaluation finale
\input{chapitres/08_evaluation_finale}
...
\input{chapitres/lab1_application}
